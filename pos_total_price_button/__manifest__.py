...
<div class="oe_module_desc">
    ...
    <p>
        ...
        is for a price-based product, the cashier can click <strong>Total Price</strong> to activate
        total-price numpad mode. The cashier then types the desired total using the numpad; the system
        computes and updates the quantity in real time (Qty = Total &divide; Unit Price). Unit price is never changed.
    </p>
    ...
    <p>
        ...
        this flag enabled. Zero unit price and missing selection are handled gracefully;
        the button is disabled when not applicable.
    </p>
    <p>
    ...
    <ol>
        ...
        <li>Click <strong>Total Price</strong>. The button turns active (highlighted) and the numpad switches to <strong>Total Price mode</strong>.</li>
        <li>Type the desired total amount using the numpad (e.g. <code>2</code>). The system computes: <strong>Qty = EnteredTotal &divide; UnitPrice</strong> and updates the order line quantity in real time.</li>
    </ol>
    <p>
    ...
    <p class="text-muted">
        <em>Step 1: Select the product (with the field enabled). Step 2: Click <strong>Total Price</strong> — the button becomes active. Step 3: Type the total amount on the numpad. The order line quantity is updated automatically.</em>
    </p>
    <p>
    ...
    <p class="text-muted">
        <em><strong>Final result:</strong> The order shows the calculated quantity (e.g. 0.25 kg) with the total matching the entered amount. The line is ready for payment.</em>
    </p>
    <p>
    ...
    <h2>Edge cases</h2>
    <p>No order line selected, product without the flag, or zero unit price — the button is disabled when not applicable and invalid numpad input is ignored.</p>
    <p>
